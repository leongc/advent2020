...
function getSeatId(input) {
  var binstr = input.replace(/[fl]/gi, '0').replace(/[br]/gi, '1');
  return parseInt(binstr, 2);
}
console.assert(getSeatId('FBFBBFFRLR') === 357);
...
*/
var seats = new Set();
for (var i = 8; i < maxSeatId; i++) { // skip the first row
  seats.add(i);
}
day05input.map(getSeatId).forEach(seat => seats.delete(seat));
console.log(seats);
