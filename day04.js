...
function hasRequiredFields(fields) {
  return ['byr', 'iyr', 'eyr', 'hgt', 'hcl', 'ecl', 'pid'].every( f => fields.has(f) );
}
...
function isValid(input) {
  ...
  for (var i = 0; i < input.length; i++) {
    if (input[i].length === 0) {
      ...
      var kvs = input[i].split(' ');
      if (kvs) {
        kvs.forEach( kv => {
          fields.add(kv.split(':', 2)[0])
        });
      }
    }  
  }
...
console.assert(isValid(day04test) === 2);
...
console.log(isValid(day04input));
...
console.assert(isValidField('byr', '2002'));
console.assert(!isValidField('byr', '2003'));

console.assert(isValidField('hgt', '60in'));
console.assert(isValidField('hgt', '190cm'));
console.assert(!isValidField('hgt', '190in'));
console.assert(!isValidField('hgt', '190'));

console.assert(isValidField('hcl', '#123abc'));
console.assert(!isValidField('hcl', '#123abz'));
console.assert(!isValidField('hcl', '123abc'));

console.assert(isValidField('ecl', 'brn'));
console.assert(!isValidField('ecl', 'wat'));

console.assert(isValidField('pid', '000000001'));
console.assert(!isValidField('pid', '0123456789'));
...
console.log(isValid2(day04input));
